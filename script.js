...
demo[0].firstElementChild.addEventListener('click',function(e) {
    window.location.href = 'https://shummi7.github.io/smoothie-app/';
}, false);
...
demo[7].firstElementChild.addEventListener('click',function(e) {
    window.location.href = 'https://shummi-quizapp.herokuapp.com/';
}, false);
 
// ----------------------------------------------------------------------------
demo[0].lastElementChild.addEventListener('click',function(e) {
    window.location.href = 'https://github.com/shummi7/smoothie-app';
}, false);
...
demo[7].lastElementChild.addEventListener('click',function(e) {
